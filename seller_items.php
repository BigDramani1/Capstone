            ...
            <div class="row justify-content-center">
                <div class="col-sm-10 col-md-7 col-lg-4">
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        ...
                        <ul class="dashboard-menu">
                            <li>
                                <a href="seller_dashboard.php"><i class="flaticon-dashboard"></i>Dashboard</a>
                            </li>
                            <li>
                                <a href="seller_profile.php"><i class="flaticon-settings"></i>Personal Profile </a>
                            </li>
                            <li>
                                <a href="seller_items.php" class="active"><i class="flaticon-star"></i>My Items</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="dash-bid-item dashboard-widget mb-40-60">
                        <div class="header">
                            <h4 class="title">My Uploaded Items</h4>
                            <div class="thumb">
