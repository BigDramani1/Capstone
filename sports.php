                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        ...
                        <div class="auction-content">
                            <h6 class="title">
                                <a href="#0">Spalding Basketball</a>
                            </h6>
                            <div class="bid-area">
            ...
            <div class="row mb-30-none justify-content-center">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        ...
                        <div class="auction-content">
                            <h6 class="title">
                                <a href="#0">Manchester United Jersey</a>
                            </h6>
                            <div class="bid-area">
                                <div class="bid-amount">
                                    <div class="icon">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        ...
                        <div class="auction-content">
                            <h6 class="title">
                                <a href="#0">Women Workout Outfit (Purple) </a>
                            </h6>
                            <div class="bid-area">
                                <div class="bid-amount">
                                    <div class="icon">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        ...
                        <div class="auction-content">
                            <h6 class="title">
                                <a href="#0">Women Workout Outfit (Pink)</a>
                            </h6>
                            <div class="bid-area">
                                <div class="bid-amount">
                                    <div class="icon">
