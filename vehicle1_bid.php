                ...
                <div class="product-details-slider owl-theme owl-carousel" id="sync1">
                    <div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="assets/images/product/11.webp" alt="product">
                        </div>
                    </div>
                    <div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="assets/images/product/12.webp" alt="product">
                        </div>
                    </div>
                    <div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="assets/images/product/13.webp" alt="product">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="product-details-content">
                        <div class="product-details-header">
                            <h2 class="title">Hyundai Venue</h2>
                            <ul>
                        ...
                        <div class="product-single-sidebar mb-3">
                            ...
                            <div class="side-counter-area">
                                ...
                                <div class="side-counter-item">
                                    ...
                                    <div class="content">
                                        <h3 class="count-title"><span class="counter">6</span></h3>
                                        <p>Total Bids</p>
                                    </div>
                                </div>
                            </div>
